...
function ( 	declare, PluginBase, ContentPane, dom, domStyle, domGeom, obj, content, enhTechs, envConds, esriapi, clicks, variables, lang ) {
	return declare(PluginBase, {
		...
		render: function() {
			...
			this.envConDiv = new ContentPane({style:'position:absolute; top:8px; left:10px; box-shadow:2px 2px 3px rgba(0,0,0,0.4); border:1px solid #444; overflow-y:hidden; border-radius:3px; background:#fff;' });
